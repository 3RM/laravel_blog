...
class ArticlesController extends Controller
{
    ...
    public function index()
    {
		...
		return View::make('admin.articles.articles',['articles'=>$articles]);
    }
    ...
    public function create()
    {
		...
		//return View::make('admin.articles.create',['categories'=>$categories']);
    ...
    public function edit($id)
    {
		...
		return View::make('admin.articles.edit',['article' => $article, 'categories'=>$categories]);
    }
